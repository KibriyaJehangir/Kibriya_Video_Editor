...
const populateGrid = (gridId, urls, category) => {
  ...
  urls.forEach((u, i) => {
    ...
    const desc = category === 'reels' ? 'Editorial pacing, elegant grade.'
      : category === 'videos' ? 'Aesthetic rhythm, soft light.'
      : category === 'cinematics' ? 'Precision lighting, dynamic motion.'
